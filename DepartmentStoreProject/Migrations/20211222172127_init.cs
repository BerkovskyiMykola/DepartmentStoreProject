    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DepartmentStoreId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentStores", x => x.DepartmentStoreId);
                    table.ForeignKey(
                        name: "FK_DepartmentStores_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shops_DepartmentStores_DepartmentStoreId",
                        column: x => x.DepartmentStoreId,
                        principalTable: "DepartmentStores",
                        principalColumn: "DepartmentStoreId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentStores_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shops_DepartmentStoreId",
                table: "Shops",
                column: "DepartmentStoreId");
        }
